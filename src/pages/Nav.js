        ...
        <div className="container mx-auto py-4">
          ...
          <nav className='flex justify-around items-center px-4'>
            ...
            <div className="flex items-center space-x-8" id="links">
              ...
              <a href="/cars" className="bg-[#4F5DEC] text-white py-3 px-5 rounded-lg" id="links">Explore</a>
              {userInfo ? (
            ...
            {navIsShown && (
              <div className='md:hidden absolute z-10 top-12 left-0  w-full text-black'>
                <ul className='text-center mb-2 bg-white p-2 mx-4'>
                  ...
                  {userInfo ? (
                    <li className="p-2">
                      <a href="#logout" onClick={signOut} className="px-3 py-2 text-lg bg-[#252c79] text-white rounded-lg hover:bg-blue-400"><b>Logout</b></a>
                    </li>
                  ) : (
                    <li className="p-2">
