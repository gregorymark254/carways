            ...
            <div className="grid grid-cols-1 gap-8 mb-20 md:grid-cols-2 lg:grid-cols-3">
              {
                cars.map((car) => (
                  <div key={car._id}>
                    <img className="rounded-xl" width={600} height={400}  src={car.src} alt="car1" />
                    <div>
      ...
      <section className="mb-20">
        <div className="container mx-auto p-4">
          ...
          <div className="flex flex-wrap items-center justify-start gap-10 mb-20 lg:justify-center">
            <div className='py-4'>
              <div>
                <img width={300}  height={300} className="rounded-xl" src="https://live.themewild.com/carway/assets/img/blog/01.jpg" alt="blog" />
              </div>
            ...
            <div className='py-4'>
              <div>
                <img width={300} height={300} className="rounded-xl" src="https://live.themewild.com/carway/assets/img/blog/02.jpg" alt="blog" />
              </div>
              <div className="flex flex-wrap items-center space-x-5 py-3">
                <div className="flex items-center space-x-2">
                  <span className="text-[#4F5DEC]"><FaRegUserCircle/></span>
            ...
            <div className='py-4'>
              <div>
                <img width={300} height={300}className="rounded-xl" src="https://live.themewild.com/carway/assets/img/blog/03.jpg" alt="blog" />
              </div>
              <div className="flex flex-wrap items-center space-x-5 py-3">
                <div className="flex items-center space-x-2">
                  <span className="text-[#4F5DEC]"><FaRegUserCircle/></span>
