                ...
                <div className="md:flex gap-6 ">
                    ...
                    <main>
                        <div className="flex justify-between py-4">
                            <div>
                            <p>Showing all {allPuma.length}</p>
                            </div>
                            <div>
                        ...
                        <div className="grid grid-cols-4 gap-2">
                            {allPuma.length > 0 ? (
                                allPuma.map(product => (
                                    <div  key={product.id}>
                                    <Link to={`/puma/details/${product.id}`} ><img src={product.src} alt="" /></Link>
                                    <div className='content'> 
                                        <h3><Link to={`/puma/details/${product.id}`}>{product.title}</Link></h3>
