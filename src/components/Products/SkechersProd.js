                ...
                <div className="md:flex gap-6 ">
                    ...
                    <main>
                        <div className="flex justify-between py-4">
                            <div>
                                <p>Showing all {allSkechers.length}</p>
                            </div>
                            <div>
                        ...
                        <div>
                            ...
                            {allSkechers.length > 0 ? (
                                allSkechers.map(product => (
                                    <div  key={product.id}>
                                        <Link to={`/skechers/details/${product.id}`} ><img src={product.src} alt="" /></Link>
                                        <div className='content'> 
                                            <h3><Link to={`/skechers/details/${product.id}`}>{product.title}</Link></h3>
